...
export default function AvatarInterviewPage({ knowledgeBaseId }) {
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center">
      {!showInterview ? (
        <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-lg space-y-4">
          <h2 className="text-xl font-bold mb-2 text-center text-gray-800">Avatar Interview</h2>
          <div>
            <label className="block font-semibold mb-2">Enter Knowledge Base ID:</label>
            <input
