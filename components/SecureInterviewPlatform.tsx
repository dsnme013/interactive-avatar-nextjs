...
export default function SecureInterviewPlatform({ onSetupComplete }: { onSetupComplete: (data: InterviewData) => void }) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      {!interviewLink ? (
        <form onSubmit={(e) => { e.preventDefault(); generateInterviewLink(); }}>
        ...
        <div className="space-y-4">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <h3 className="font-semibold text-green-800 mb-2">Interview Link Generated!</h3>
            <p className="text-sm text-gray-600 mb-3">Share this link with the candidate:</p>
