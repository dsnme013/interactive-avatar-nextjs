...
export default function SecureInterviewPage() {
  ...
  const handleEmailVerification = (e: React.FormEvent) => {
    ...
    if (interviewData && email.toLowerCase() === interviewData.candidateEmail.toLowerCase()) {
  ...
  if (verificationStep === 'verified' && interviewData) {
    return <AvatarInterviewPage knowledgeBaseId={interviewData.knowledgeBaseId} />;
  }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        <div className="flex items-center justify-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Secure Interview Access</h1>
        </div>

        {interviewData && (
          <div className="mb-6 text-center">
            <p className="text-gray-600">
              Interview for: <span className="font-semibold">{interviewData.position}</span>
            </p>
            <p className="text-gray-600">
              at <span className="font-semibold">{interviewData.companyName}</span>
            </p>
          </div>
        )}
